...
def print_logo ():#line:7:def print_logo():
    ...
    print ("   ║  🖊️ Author     : HAQ CYBER SQUAD                                    ║")#line:27:print("   ║  🖊️ Author     : HAQ CYBER SQUAD                                    ║")
...
def login ():#line:37:def login():
    ...
    while O0O0OO0000OO00O00 <3 :#line:44:while attempts < 3:
        ...
        if O0000000OOO000O00 =="Haq Cyber Squad"and OO00OO00OO0OOO00O =="Safwan Al Sadaf":#line:48:if username == "Haq Cyber Squad" and password == "Safwan Al Sadaf":
            print ("\n   ✅ Login Successful!\n")#line:49:print("\n   ✅ Login Successful!\n")
